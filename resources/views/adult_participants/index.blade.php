    ...
    <div class="py-12 bg-[#F9FAF9] min-h-screen">
        <div class="max-w-7xl mx-auto px-6">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-3xl font-bold text-[#171463]">Adult Participants</h1>
                <a href="{{ route('adult-participants.create') }}" class="bg-[#DA1C59] text-[#F9FAF9] px-4 py-2 rounded-lg hover:bg-[#171463] transition duration-300">Add New Participant</a>
            </div>
                    ...
                    <tbody class="divide-y divide-[#9CAEEB]">
                        @foreach ($participants as $participant)
                            <tr class="hover:bg-[#9CAEEB]/10 transition duration-300">
                                <td class="px-6 py-4 text-[#171463]">{{ $participant->full_name }}</td>
                                <td class="px-6 py-4 text-[#171463]">{{ $participant->age }}</td>
                                <td class="px-6 py-4 text-[#171463]">{{ $participant->cin }}</td>
                                <td class="px-6 py-4 text-[#171463]">{{ $participant->city }}</td>
                                {{-- <td class="px-6 py-4 text-[#171463]">{{ $participant->adultActivity->activity_name }}</td> --}}
                                <td class="px-6 py-4 text-[#171463]">{{ $participant->adultActivity ? $participant->adultActivity->activity_name : 'N/A' }}</td>
                                <td class="px-6 py-4 space-x-2">
                                    <!-- View Button -->
                                    <a href="{{ route('adult-participants.show', $participant->id) }}" class="bg-[#9CAEEB] text-[#F9FAF9] px-3 py-2 rounded-lg hover:bg-[#171463] transition duration-300" title="View">
                                        <i class="fas fa-eye fa-sm"></i>
                                    </a>

                                    <!-- Edit Button -->
                                    <a href="{{ route('adult-participants.edit', $participant->id) }}" class="bg-[#DA1C59] text-[#F9FAF9] px-3 py-2 rounded-lg hover:bg-[#171463] transition duration-300" title="Edit">
                                    ...
                                    <!-- PDF Button -->
                                    <a href="{{ route('minor_participants.export.pdf', $participant->id) }}" class="bg-[#171463] text-[#F9FAF9] px-3 py-2 rounded-lg hover:bg-[#DA1C59] transition duration-300" title="Export PDF">
