                ...
                <form action="{{ route('minor_participants.update', $minorParticipant->id) }}" method="POST">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="activity_name" id="activity_name" value="{{ $minorParticipant->activity_name }}" class="mt-1 block w-full px-4 py-2 border border-[#9CAEEB] rounded-lg focus:ring-[#EF6B69] focus:border-[#EF6B69] transition duration-300" required>
                        </div>
