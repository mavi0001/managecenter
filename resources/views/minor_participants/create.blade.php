...
<div class="container mx-auto p-6 bg-[#F9FAF9] min-h-screen">
    ...
    <form action="{{ route('minor_participants.store') }}" method="POST" class="bg-white p-6 rounded-lg shadow-lg border border-[#9CAEEB]">
        @csrf
        <div class="space-y-4">
            <!-- Full Name -->
            <div class="form-group">
                <label for="full_name" class="block text-sm font-medium text-[#3A406D]">Full Name</label>
                <input type="text" name="full_name" id="full_name" class="mt-1 block w-full px-4 py-2 border border-[#9CAEEB] rounded-lg focus:ring-[#EF6B69] focus:border-[#EF6B69] transition duration-300" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="date" name="date_of_birth" id="date_of_birth" class="mt-1 block w-full px-4 py-2 border border-[#9CAEEB] rounded-lg focus:ring-[#EF6B69] focus:border-[#EF6B69] transition duration-300" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="activity_name" id="activity_name" class="mt-1 block w-full px-4 py-2 border
                border-[#9CAEEB] rounded-lg focus:ring-[#EF6B69] focus:border-[#EF6B69] transition duration-300" required>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="observation" id="observation" class="mt-1 block w-full px-4 py-2 border border-[#9CAEEB] rounded-lg focus:ring-[#EF6B69] focus:border-[#EF6B69] transition duration-300"></textarea>
            </div>
        </div>

        <!-- Submit Button -->
        <button type="submit" class="mt-6 bg-[#EF6B69] text-[#F9FAF9] px-6 py-2 rounded-lg hover:bg-[#3A406D] transition duration-300 w-full sm:w-auto">Submit</button>
    </form>
</div>
</x-app-layout>
