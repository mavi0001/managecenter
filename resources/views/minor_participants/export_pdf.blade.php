...
<body class="bg-[#F9FAF9] flex items-center justify-center min-h-screen p-6">
    <div class="bg-white rounded-xl shadow-2xl border border-[#9CAEEB] p-8 max-w-2xl w-full">
        <!-- Header Section -->
        <div class="text-center mb-8">
            <h2 class="text-3xl font-bold text-[#3A406D]">Centre d'Accueil</h2>
            <p class="text-sm text-[#3A406D] mt-2">Date: {{ now()->format('d/m/Y') }}</p>
        </div>

        <!-- Photo Placeholder -->
        <div class="flex justify-center mb-8">
            <div class="w-32 h-32 bg-[#9CAEEB] rounded-full flex items-center justify-center text-[#F9FAF9] text-lg font-semibold shadow-md">
                Photo
            </div>
        </div>
