                        ...
                        @foreach ($activities as $activity)
                            <tr class="hover:bg-[#9CAEEB]/10 transition duration-300">
                                ...
                                <td class="px-6 py-4 space-x-2">
                                    <!-- View Button -->
                                    <a href="{{ route('adult-activities.show', $activity->id) }}" class="bg-[#9CAEEB] text-[#F9FAF9] px-3 py-2 rounded-lg hover:bg-[#3A406D] transition duration-300" title="View">
                                        <i class="fas fa-eye fa-sm"></i> 
                                    </a>

                                    <!-- Edit Button -->
                                    <a href="{{ route('adult-activities.edit', $activity->id) }}" class="bg-[#EF6B69] text-[#F9FAF9] px-3 py-2 rounded-lg hover:bg-[#3A406D] transition duration-300" title="Edit">
